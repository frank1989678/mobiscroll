        ...
        that.show = function (prevAnim) {
            ...
            if (modal && hasButtons) {
                ...
                $.each(buttons, function (i, b) {
                    ...
                    html += '<span' + (s.btnWidth ? ' style="width:' + (100 / buttons.length) + '%"' : '') + ' class="dwbw ' + b.css + '"><a href="javascript:;" class="dwb dwb' + i + ' dwb-e" role="button">' + b.text + '</a></span>';
                });
                html += '</div>';
            }
